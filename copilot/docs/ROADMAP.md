...
| **Make onboarding a symbol one command**                                                                                     | 00    | Adding six symbols on 2026-09-04 took a vendor-coverage probe, a backfill, two Databento pulls, a hole patch, a spread recalibration, a repin, six registry files, a holdout-boundary computation and a validate - in an order that exists only in the commit message. Each step is sound; the sequence is knowledge nobody wrote down.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
