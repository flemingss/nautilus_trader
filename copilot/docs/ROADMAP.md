...
| **Measure corporate actions for any new symbol before use**                                                                  | 00    | The action table covers today's twenty. An unlisted action is a silent discontinuity again, so widening the universe starts with the same vendor check.                                                                                                                                                                                                                                                                         |
...
| **Record the bulk quote store as machine state**                                                                             | 00    | 1.2 GB of purchased minute bars and quotes sit at `~/.nautilus_copilot/databento`, outside the repository and absent from the new-machine checklist. Unlike the catalog it is **replaceable** - the same pull costs $19.54, or nothing against remaining credit - so this needs a line in [`MAINTENANCE.md`](MAINTENANCE.md), not a backup.                                                                                     |
