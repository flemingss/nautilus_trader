...
| **Decide what the SCHX spend is, now that its data was wrong** | 02     | The operator-day walk of 2026-09-04 found two SCHX splits unregistered and sitting in the stored prices - the 3:1 of 2024-10-11 inside the holdout window as a -67% gap-down. The holdout was spent on that series and failed on four trades. Registered now and the series reads continuous, but ADR-0014 makes a spend single-use and the record cannot be re-spent by anyone but the owner's decision. Sharper than the unscorable-spend question: this spend scored a series that did not exist.                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
Eighteen rows closed on 2026-09-03 and 2026-09-04 moved to [`CHANGELOG.md`](CHANGELOG.md);
...
| **Add a corporate-actions stage to `onboard`**                         | 00    | The onboarding drill never ran `corporate_actions`, and `onboard`'s five stages did not include it; the walk that evening found three splits sitting in the prices of two newly onboarded symbols, one inside a holdout. The scan exists and exits 1 on exactly this; the stage is a call to it between "holes filled" and "spread calibrated", and the sequence is not complete without it.                                                                                                      |
