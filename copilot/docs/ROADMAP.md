...
Forty-one items. Grouped by blocking condition rather than by component, because that is
...
open with batch C. **Batch B closed 2026-09-11** the same way: eleven rows built, and the
