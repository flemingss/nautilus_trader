...
| **Cap exposure across activations, not just within one**                                                                     | 06    | Twelve activations size independently and nothing aggregates them. SCHX, XLF, HYG and EEM are one risk-on trade in four wrappers, so a gap-down morning is four full risk budgets at once. The per-order controls cannot see this because it is not a per-order property.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
