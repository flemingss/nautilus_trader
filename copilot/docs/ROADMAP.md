...
| **Decide what a pooled holdout may contain**                                           | 02    | `copilot.strategies.pool` refuses to spend one and says why. AAPL, MSFT and SPY have viewed holdout windows (ADR-0014), so a pooled holdout containing them is not out of sample. The options are to exclude the spent symbols - which removes the three longest histories - or to accept a contaminated window and label it. Owner decision; the tool will not pick a default.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
