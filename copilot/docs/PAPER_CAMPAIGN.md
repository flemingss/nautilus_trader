...
**Reopened and largely withdrawn, 2026-09-10.** The probe reproduced the same verdict on
the shakedown, and this time the order was followed afterwards. It was cancelled. The
sequence, all on one stranded order:

| Time (ET) | Cancel sent from                   | Observed 30s later                     |
| --------- | ---------------------------------- | -------------------------------------- |
| 11:32     | recovery node, 842                 | working, `PENDING_CANCEL`              |
| 11:39     | sweep, 822                         | working, `PENDING_CANCEL`              |
| 11:41     | sweep, 832 - the placing partition | working                                |
| 11:42     | -                                  | **gone from the broker's open orders** |

So the foreign cancel is **acknowledged late, not refused**, and the adapter does emit
`PENDING_CANCEL`, which the 2026-09-02 run could not even do. What is *not* settled is
whether the acknowledgement that landed was one of the foreign cancels arriving after
two minutes or the native one from 832 arriving in one; a single stranded order cannot
separate them, and separating them costs another strand. The 2026-09-02 diagnosis - that
the adapter's ID maps have no entry for a foreign order - was correct for the code as it
then stood and has since been fixed; the `Trader ID not found` error does not appear in
the 2026-09-10 logs.

**What was actually broken was the deadline.** Both the probe and the sweep slept a fixed
30s and then declared the cancel refused, which is a verdict of *refused* that means *not
yet*. That is worse than no verdict: it sends the operator to the TWS order list to
cancel an order the broker has already cancelled, and it teaches them the FAIL means
nothing. Both now wait on `CANCEL_DEADLINE_SECS` and return the moment the
acknowledgement lands, so the deadline costs nothing when the cancel is honoured and a
failure means the deadline genuinely passed.
...
| ---------- | ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-11 | evening, drill          | **The day's evening for Monday's session, 6 of 6 PASS in 2m20s, and the replay agrees again.** 17:25 ET, orders denied, run early as a drill of the VM's code: append (TLT's refused 2026-09-10 close patched from Databento first), scan, preflight, warm-up, basket, sweep *BROKER CLEAR*. The basket ran with live strategies no longer subscribed to broker bars, and `compare` read **9 of 9 AGREE**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `live/out/day_evening_20260911T212504Z.json`, `live/out/run_activation_20260911T212547Z.json`, `live/out/sweep_20260911T212638Z.json`, `live/out/compare_20260911T212724Z.json` |
| 2026-09-11 | morning                 | **9 of 9 DISAGREE, on skip counts alone: the broker's bar reached every strategy before its warm-up.** 17:16 ET: append refused TLT's 2026-09-10 close (80.652, not a whole cent), scan clean, twelve verdicts refiled after a code change with identical numbers, and the comparison of the 2026-09-10 basket found one `insufficient_history` skip in every live record. Since the 2026-09-09 subscriptions IB answers the strategy's daily-bar subscription, and its bar arrived during the settle wait. Fixed the same evening.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `live/out/day_morning_20260911T211604Z.json`, `live/out/compare_20260911T211844Z.json`                                                                                          |
| 2026-09-11 | preflight, settled cash | **IB sends no settled cash for the paper margin account, and preflight now says so rather than failing.** 16:42 ET, after the close, orders disabled: the new `account_reports_settled_cash` check failed on its first run - of the ten account-summary tags the adapter requests, nine reached the account state and `SettledCash` did not, and a diagnostic dump of every account event confirmed it. A margin account now has no settled-cash cap and the record says why; any other account type must report the figure or the basket refuses. Re-run at 16:47 ET: **16 of 16 PASS**, the check reading *not applicable*. Whether IB sends the tag for a cash account is only answerable on the live account.                                                                                                                                                                                                                                                                                                                                               | `live/out/preflight_20260911T204241Z.json`, `live/out/preflight_20260911T204732Z.json`                                                                                          |
| 2026-09-11 | basket, guard           | **The protection guard runs in a live node for the first time.** `run_activation --all` for the 2026-09-10 session (the catalog ends 2026-09-09), orders denied: the guard started without settings, waited, was configured once the equity was read (USD 1,000,854.29), and reported active with no breach; every activation's record names its ledger. Two activations deferred a next-close entry (SCHX, SPY), recorded and not carried, which is now a decision row.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `live/out/run_activation_20260911T154025Z.json`                                                                                                                                 |
| 2026-09-11 | latch watch drill       | **A running node halts when the latch appears.** An order-capable node on 891/892 read `ACTIVE`; the latch was engaged mid-run and within eight seconds the engine read `HALTED` with the watch's error line naming latch `41ccacda`; after release it still read `HALTED`, because the watch never releases.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | this session's log                                                                                                                                                              |
| 2026-09-11 | sweep, global cancel    | **The sweep clears an order another client placed.** Rebuilt with IB's global cancel on cancels-only sessions (ADR-0029). 11:06 ET: one AAPL limit stranded from 832; 11:07 the sweep from 822 sent the global cancel; census 1 read nothing open, `BROKER CLEAR`. One ERROR line followed, the per-order path failing to resolve the order the global cancel had removed, so the per-order path is now skipped under it. 11:12: repeated on that build, strand from 832 cleared at census 1 with no error line.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `live/out/sweep_20260911T150722Z.json`, `live/out/sweep_20260911T151241Z.json`                                                                                                  |
| 2026-09-11 | sweep, batch A          | **The fixed sweep starts, and its cancels cannot reach another client's order.** 10:32 ET: one AAPL buy limit at 157.67, half the market, stranded from client 832. 10:33: the sweep started for the first time since 2026-09-10, found the order and sent its cancel from 822; the order went `PENDING_CANCEL` and census 1 still read it open; census 2 reused census 1's client ids, TWS refused them with IB 326, and the startup failure crashed the sweep before a verdict. Fixed (one id pair per census; a failed node is an unread census). 10:41: the second sweep sent a second cancel from 822; four censuses on four id pairs read the order open to 10:54; `STILL WORKING`; the CRITICAL was undelivered on this box and engaged latch `4fa491f4`, released by hand. 10:55: one cancel from 832, the placing client; 10:58: census clear. **IB ignores a cancel from another client id**, which settles the 2026-09-10 question above - the native cancel was the one that worked - and is why the sweep now sends IB's global cancel (ADR-0029). | `live/out/sweep_20260911T144059Z.json`, `live/out/halt_release_20260911T145825Z.json`                                                                                           |
| 2026-09-11 | sweep, audit            | **The sweep's cancel has not run since 2026-09-10.** `cancel_working --all` against paper TWS at 09:56 ET, inside the session: the cancel node logged *Stop signal received during startup, aborting startup* twelve seconds after build and never started its strategy, because the settlement wait is satisfied before the strategy has looked. The census node started, read `IB-DUT067974` and reported nothing open, `BROKER CLEAR`. The verdict is honest and the cancel is missing; nothing was placed. Also measured the same morning: the timer gating on the live clock (a scheduled evening, morning and pre-open each *nothing to do* at 09:48 ET; a scheduled sweep refused for missing Pushover credentials before connecting), and the suite at 1,038 passing under 0.51 GiB.                                                                                                                                                                                                                                                                    | this session's log; `cancel_working` files no record, which the roadmap row now requires                                                                                        |
| 2026-09-10 | kill drill              | **Latch engaged, sweep ran under it, release refused a wrong id.** `kill --reason` engaged latch `cb59138d` at 22:44 ET; the cancels-only sweep ran to `BROKER CLEAR` under it; nodes built while latched read `HALTED` from the real risk engine when requesting orders and `ACTIVE` when cancels-only; after release the order-requesting node read `ACTIVE`. In light of the 2026-09-11 finding, the sweep's cancel did not run in this drill either; its census did.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `live/out/halt_release_20260911T024522Z.json`                                                                                                                                   |
| 2026-09-10 | sweep, census           | **First broker-confirmed verdict.** 22:29 ET, after the close: nine instruments, nothing found, census 1 read the account and nothing open, `BROKER CLEAR`, peak resident memory 0.33 GiB. Read with the 2026-09-11 row above: the census is what confirmed it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | not filed; the sweep writes no record                                                                                                                                           |
| 2026-09-10 | evening                 | **Blocked at warm-up, correctly.** Preflight passed; warm-up refused all twelve activations because the session opening 2026-09-11 needs 2026-09-10's bar and the catalog ends 2026-09-09. `append` confirms why: today's bar is **pending** at the vendor, the known EQUS.SUMMARY licence lag. The refusal is the designed behaviour - *a strategy warmed from a hole does not stop trading, it trades on a gap that did not happen* - but it means the evening command cannot complete on the evening it is named for. Filed as open work.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `live/out/day_evening_20260910T200552Z.json`                                                                                                                                    |
| 2026-09-10 | close, shakedown        | **2 of 2 PASS**, and the closing contrast corroborates [ADR-0019](decisions/0019-spread-is-charged-from-measured-history.md). Fifteen minutes of realtime quotes into the close: AAPL median **0.4607** bps/side against **1.2491** in the execution window, MSFT **0.7130** against **1.7374**, SPY **0.1320** against 0.1320 - already at its tick floor and unmoved. ADR-0019 refused to charge the closing spread because it would price a window no order uses and cost *roughly half* the execution window; measured live the gap is larger than that, about **a third** for AAPL. The sweep found all nine instruments clear.                                                                                                                                                                                                                                                                                                                                                                                                                            | `live/out/shakedown_close_20260910T191505Z.json`, `calibration/out/spread_snapshot_20260910T191507Z.json`                                                                       |
| 2026-09-12 | commission plan         | **The account is on IBKR Pro with stocks Tiered, and the pin moved with it.** The owner's Client Portal action, which was the last open half of ADR-0025. `SCHEDULE` is now `TIERED`, so every verdict must be recomputed against it - held to run once alongside the gap allowance, since both change every R. **Not yet confirmed empirically:** the 2026-09-10 round trip below is how Fixed was proven, by paying the USD 1.00 minimum twice. The next shakedown round trip should pay about USD 0.35 plus the exchange and clearing pass-through instead, and until one does, the plan is confirmed by the account settings rather than by the tape.                                                                                                                                                                                                                                                                                                                                                                                                       | `calibration/out/commission_revalidation_20260910.json`                                                                                                                         |
| 2026-09-10 | order-window, shakedown | **3 of 3 PASS, and the commission structure is confirmed empirically.** The controlled order rested 1 AAPL BUY LIMIT at 157.67 - half the market - accepted as venue order 812000002 and cancelled; the order-type matrix passed during regular hours for the first time. The round trip filled at 322.56 and exited at 322.52 for **-2.14 USD of which 2.02 USD was commission**: the USD 1.00 per-order minimum charged twice, so the account is still on **IB Pro Fixed**. At the charter's USD 20 risk that is 0.101 R per trade against an AAPL holdout edge of 0.035 R. Nothing left working.                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `live/out/shakedown_order-window_20260910T152157Z.json`                                                                                                                         |
| 2026-09-10 | open, shakedown         | **The broker's tape corroborates the Databento-derived spread coefficient.** Fifty minutes of realtime quotes inside the execution window: AAPL median **1.2491** bps/side over 21,249 samples, MSFT **1.7374** over 12,410, SPY **0.1320** over 35,258. The cost model charges **1.9107** bps/side, which sits above today's AAPL median and below its p95 - conservative without being punitive. The incumbent 5.0 bps/side assumption overstates AAPL by 4.0x.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `calibration/out/spread_snapshot_20260910T133006Z.json`                                                                                                                         |
| 2026-09-10 | midday, shakedown       | **2 of 3.** Failure injection **PASS** - the per-order notional cap denied as designed (`NOTIONAL_EXCEEDS_MAX_PER_ORDER`, the 2026-09-01 engine fix, watched working) and the stale feed was detected at 20.8s. Subscription interference **NOT REPRODUCED**: AAPL kept 1069 quotes against a 1151 baseline under a second subscription. Strand recovery **FAIL**, and the failure is the deadline, not the cancel - see *the fourth case* above; the order was cancelled and the account is clear.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `live/out/shakedown_midday_20260910T153005Z.json`                                                                                                                               |
| 2026-09-10 | 1-2, pre-open           | **The pre-open question is answered: the feed quotes before the bell.** Delayed 15/15 at 09:02 ET, realtime 14/15. The one failure is a finding, not a fault: TLT quoted **80.96/80.96**, a locked book, and the check demanded a bid strictly below the ask where the playbook asks only for non-crossed. Fixed the same hour. Alerting fired and reported **NOT delivered**, correctly, because no Pushover credentials are exported on this box.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `live/out/shakedown_pre-open_20260910T130209Z.json`                                                                                                                             |
| 2026-09-10 | morning                 | **Clean.** Append had nothing to add, the corporate-actions scan found nothing, twelve verdicts recomputed after the week's code changes, and the replay comparison agreed **9 of 9** - the scorecard's *signal-to-intent parity against an independent replay*.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `live/out/day_morning_20260910T130517Z.json`                                                                                                                                    |
| 2026-09-09 | 1-2                     | **Pass, 15/15** from the second machine (Florida, EDT), after the close, on the delayed setting, with the three consolidated feeds newly subscribed. Same session: historical bars returned for AAPL and SPY where 2188 had stood, and realtime streaming recorded 47/61/139 quotes against a 35/64/120 delayed control. Pre-open quoting still unmeasured.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `live/out/preflight_20260909T204052Z.json`, `calibration/out/spread_snapshot_20260909T2043{19,529}Z.json`                                                                       |
| 2026-09-09 | 1-2                     | **FAIL, 0/9 quotes, stages 1-2 pass.** First connection from the second machine: every quote subscription refused with IB 10197 *No market data during competing live session* - the live username was logged in elsewhere. Cleared by logging that session out; not an entitlement finding.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `live/out/preflight_20260909T202508Z.json`                                                                                                                                      |
...
| Working-order sweep           | [`../live/cancel_working.py`](../live/cancel_working.py)                       | Built and run. The census verdict is confirmed against the broker; **the cancel has not run since 2026-09-10** (roadmap row).  |
